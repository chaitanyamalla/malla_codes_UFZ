...
search_dir=/work/malla/meteo_germany/DE_indicatorsdata/facc/Bodensee/data_qrouted_daily
...
do
  ...
  istnlst="./Bodensee.csv" #list of lat-lon for which to extract TS
  ...
  cat $ofile*.csv >> ./dams_output_csv/${file}.csv
  rm -f ./data_tmp/*
