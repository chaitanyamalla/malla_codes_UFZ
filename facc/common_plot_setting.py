...
colors_GnBu9= get_brewer('GnBu9', rgb= True)
...
colors_precip    = ["#fac8ff","#ec3bff","#a900ba","#a50000","#e11400","#ff6000","#ffc03c","#fffaaa","#b4faaa","#78f573","#37d23c","#0fa00f","#2882f0","#50a5f5","#96d2fa","#b4f0fa","#c8a096","#e1beb4","#f0dcd2","#faf0e6"]
...
if indicator == 'pre_sum':
    ...
    colors_rel_change              = colors_Reds9[1::][::-1] + colors_Blues9[1::]
    # colors_rel_change              = colors_Reds9[1::][::-1]+ whitewhite +colors_GnBu9[1::]
    levels_rel_change            = np.arange(-30,33,3)
    levels_rel_change            = np.arange(-24,27,3)
...
if indicator == 'pre_sum':
    colors_abs              = colors_precip[::-1]
    if eval_period == "year":
        levels_abs            = np.arange(400,2300,100)
    else:
