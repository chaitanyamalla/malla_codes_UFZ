...
# --------------------------------------------------
#  File:        plot_tmax30_monthly_new.py 
#
...
d0= read("ensmedian_monthly_heatdays_"+ind+"_historic.nc") 
d1= read("ensmedian_monthly_heatdays_"+ind+"_1_5K.nc")
d2= read("ensmedian_monthly_heatdays_"+ind+"_2K.nc")
d3= read("ensmedian_monthly_heatdays_"+ind+"_3K.nc")
...
data1_rel.iloc[[1,2,3,-1,-2,-3,-4,]]=np.nan
data2_rel.iloc[[1,2,3,-1,-2,-3,-4,]]=np.nan
data3_rel.iloc[[1,2,3,-1,-2,-3,-4,]]=np.nan
...
plt.savefig(outpath+ind+"/"+ind+"30_all3_monthly_new.png")
plt.show()
res_abs= data1_abs.join([data2_abs,data3_abs])
res_rel= data1_rel.join([data2_rel,data3_rel])

res_abs.to_csv(outpath+ind+"/"+ind+"30_abs_change_monthly_new.csv")
res_rel.to_csv(outpath+ind+"/"+ind+"30_rel_change_monthly_new.csv")
