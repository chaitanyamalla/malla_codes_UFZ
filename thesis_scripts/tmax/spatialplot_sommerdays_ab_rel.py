...
# --------------------------------------------------
#  File:        spatialplot_sommerdays_abs_rel.py 
#
...
data0 = xr.open_dataset(inpath+"ensemblemedian25_" +indicator+"_historic.nc")
data1 = xr.open_dataset(inpath+"ensemblemedian25_" +indicator+ "_1_5K.nc")
data2 = xr.open_dataset(inpath+"ensemblemedian25_" +indicator+ "_2K.nc")
data3 = xr.open_dataset(inpath+"ensemblemedian25_" +indicator+ "_3K.nc")
...
levels        = np.arange(5,74,5)
#colorbarlabel = 'mittl. Anzahl Sommertage [tmax >25°C] pro Jahr'
colorbarlabel = "Number of Average Summerdays [tmax >25°C] per Year"
...
plt.savefig(outpath+"summerdays_absolute_values_large.png")
#plt.show()
...
colorbarlabel = 'Absolute Change Summerdays [n/yr]'
...
plt.savefig(outpath+"summerdays_absolutechange_large.png")
#plt.show()
...
plt.savefig(outpath+"Summerdays_relativechange_large.png")
plt.show()
...
# print(dae)
# dae.to_csv(outpath+indicator+"sommerdays_values.csv")
