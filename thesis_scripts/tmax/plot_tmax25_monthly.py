...
d = ax1.bar(x + 0.2, data3_abs.a, label="3 °C" ,width=w, color = "#B0326B")
c = ax1.bar(x + w/2, data2_abs.a, label="2 °C" ,width=w,color = "#D136F2")
b = ax1.bar(x - w/2, data1_abs.a, label="1.5 °C" ,width=w,color = "#F86FDE")

# d = ax.bar(x + 0.2, data3_abs.a, label="3 °C" ,width=w, color = "#C34E20")#use for aET pet
# c = ax.bar(x + w/2, data2_abs.a, label="2 °C" ,width=w,color = "#D59044")
# b = ax.bar(x - w/2, data1_abs.a, label="1.5 °C" ,width=w,color = "#DFBD42")
