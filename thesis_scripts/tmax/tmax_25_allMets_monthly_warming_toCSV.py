...
# --------------------------------------------------
#  File:       tmax_25_recharge_allMets_monthly_warming_toCSV.py
#
...
def readfile(filename,var):
    ...
    r_h.to_netcdf(outpath+ind+"/"+"ensmedian_monthly_summerdays_"+filename)
...
result.to_csv(outpath+"tmax25_monthly_ensmedian.csv")
print(result)
