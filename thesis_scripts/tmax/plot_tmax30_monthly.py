...
outpath=("/work/malla/sachsen_output/monthly/plots_median/tmax/")
...
data_hist= read(inpath+indicator+"_historic_monthly.csv")
...
#ax.set_xlabel("Month")
ax.set_ylabel("Heatdays [n/month]")
ax.set_title("Heatdays tmax>30 °C (absolute values)")
ax.legend()
...
x = np.arange(len(labels))
#fig, ax = plt.subplots(figsize=(12,6))
# d = ax1.bar(x + 0.2, data3_abs.a, label="3 °C" ,width=w, color = "#FF5733")
# c = ax1.bar(x + w/2, data2_abs.a, label="2 °C" ,width=w,color = "#4A5ABF")
# b = ax1.bar(x - w/2, data1_abs.a, label="1.5 °C" ,width=w,color = "#39A20C")
d = ax1.bar(x + 0.2, data3_abs.a, label="3 °C" ,width=w, color = "#EF4508")
c = ax1.bar(x + w/2, data2_abs.a, label="2 °C" ,width=w,color = "#E97B14")
b = ax1.bar(x - w/2, data1_abs.a, label="1.5 °C" ,width=w,color = "#EFB908")

ax1.set_xticks(x)
ax1.set_xticklabels(labels)
#ax1.set_xlabel("Month")
ax1.set_ylabel("Heatdays [n/month]")
ax1.set_title("Heatdays (absolute change)")
#plt.legend()
ax1.legend()
# plt.savefig(outpath+indicator+"_abschange_monthly_bar.png")
# plt.show()
...
x = np.arange(len(labels))
#fig, ax = plt.subplots(figsize=(12,6))
# d = ax.bar(x + 0.2, data3_rel.a, label="3 °C" ,width=w, color = "#FF5733")
# c = ax.bar(x + w/2, data2_rel.a, label="2 °C" ,width=w,color = "#4A5ABF")
# b = ax.bar(x - w/2, data1_rel.a, label="1.5 °C" ,width=w,color = "#39A20C")
d = ax2.bar(x + 0.2, data3_rel.a, label="3 °C" ,width=w, color = "#CD3717")
c = ax2.bar(x + w/2, data2_rel.a, label="2 °C" ,width=w,color = "#E88552")
b = ax2.bar(x - w/2, data1_rel.a, label="1.5 °C" ,width=w,color = "#D85B9D")
ax2.set_xticks(x)
ax2.set_xticklabels(labels)
ax2.set_xlabel("Month")
ax2.set_ylabel("Heatdays [%]")
ax2.set_title("Heatdays (relative change)")
#plt.legend()
ax2.legend()
