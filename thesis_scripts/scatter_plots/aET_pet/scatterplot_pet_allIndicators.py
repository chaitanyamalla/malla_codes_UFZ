...
# --------------------------------------------------
#  File:        scatterplot_pet_allIndicators.py 
#
...
ax.set_ylabel("Potential Evapotranspiration [mm/year]")
...
ax.set_ylabel("pET Absolute change [mm/year]")
...
ax.set_ylabel("Potential Evapotranspiration(aET) [%]")
