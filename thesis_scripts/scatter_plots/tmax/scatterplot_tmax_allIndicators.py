...
# --------------------------------------------------
#  File:        scatterplot_tmax_allIndicators.py 
#
...
outpath = "/work/malla/sachsen_output/scatter_plots/plots/tmax/"
...
#ax.set_ylabel("Heatdays(tmax >30 °C) [n/year]")
ax.set_ylabel("Heatdays(tmax >30 °C) [n/year]")
ax.set_xlabel("Summerdays(tmax >25 °C) [n/year]")
...
ax.set_ylabel("Heatdays Absolute change [n/year]")
#ax.set_xlabel("Recharge Absolute change [mm/year]")
ax.set_xlabel("Summerdays Absolute change [n/year]")
plt.legend(prop={'size': 12})
plt.setp(ax.spines.values(), linewidth=0.5)
plt.tight_layout()
...
ax.set_ylabel("Heatdays [%]")
#ax.set_xlabel("Recharge [%]")
ax.set_xlabel("Summerdays [%]")
plt.legend(prop={'size': 12})
plt.setp(ax.spines.values(), linewidth=0.5)
plt.tight_layout()
