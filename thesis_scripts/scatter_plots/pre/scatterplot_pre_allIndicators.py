...
# --------------------------------------------------
#  File:        scatterplot_pre_allIndicators.py 
#
#  Created:     Do 05-10-2021 
...
outpath = "/work/malla/sachsen_output/scatter_plots/plots/pre/"
...
ax.set_ylabel("Annual precipitation [mm/year]")
...
ax.set_ylabel("Precipitation Absolute change [mm/year]")
