...
# --------------------------------------------------
#  File:        spatialplot_pre_abs_rel.py 
#
#  Created:     Mi 22-06-2021 
...
inpath = "/work/malla/sachsen_output/spatial/data/pre/"
outpath = "/work/malla/sachsen_output/spatial/plots_median/pre/"
indicator = "pre"
...
colorbarlabel = 'Precipitation [mm/yr]'
levels        = np.arange(500,1200,50)
...
a = data0.pre.plot(ax=ax[0,0], cmap = cmap, levels= levels, add_colorbar=False)
b = data1.pre.plot(ax=ax[0,1], cmap = cmap, levels= levels, add_colorbar=False)
c = data2.pre.plot(ax=ax[1,0], cmap = cmap, levels= levels, add_colorbar=False)
d = data3.pre.plot(ax=ax[1,1], cmap = cmap, levels= levels, add_colorbar=False)
...
plt.savefig(outpath+indicator+"_absolutevalues_large.png")
#plt.show()
...
#cmap = mpl.colors.ListedColormap(cmap_2[::-2] + cmap_1[::1])
#cmap.set_over("#0D290D")
...
b = data1_abs.pre.plot(ax=ax[0], cmap = cmap, levels= levels, add_colorbar=False)
c = data2_abs.pre.plot(ax=ax[1], cmap = cmap, levels= levels, add_colorbar=False)
d = data3_abs.pre.plot(ax=ax[2], cmap = cmap, levels= levels, add_colorbar=False)
...
plt.savefig(outpath+indicator+"_absolutechange_large.png")
# plt.show()
...
b = data1_rel.pre.plot(ax=ax[0], cmap = cmap, levels= levels, add_colorbar=False)
c = data2_rel.pre.plot(ax=ax[1], cmap = cmap, levels= levels, add_colorbar=False)
d = data3_rel.pre.plot(ax=ax[2], cmap = cmap, levels= levels, add_colorbar=False)
...
plt.savefig(outpath+"pre_relativechange_large.png")
plt.show()
...
# print(dae) 
# dae.to_csv(outpath+indicator+"_values_.csv")
