...
# --------------------------------------------------
#  File:        plot_recharge_adj_monthly.py 
#
#  Created:     Mi 06-10-2021 
...
indicator = "rech_adjust"

inpath=("/work/malla/sachsen_output/monthly/csv/")
outpath=("/work/malla/sachsen_output/monthly/plots_median/recharge/")
...
x = np.arange(len(labels))
#fig, ax = plt.subplots(figsize=(12,6))
d = ax1.bar(x + 0.2, data3_abs.a, label="3 °C" ,width=w, color = "#10732E")
c = ax1.bar(x + w/2, data2_abs.a, label="2 °C" ,width=w,color = "#5AC219")
b = ax1.bar(x - w/2, data1_abs.a, label="1.5 °C" ,width=w,color = "#CBD83F")
...
x = np.arange(len(labels))
# fig, ax = plt.subplots(figsize=(12,6))
d = ax2.bar(x + 0.2, data3_rel.a, label="3 °C" ,width=w, color = "#40AB88")#107E22 #208731
c = ax2.bar(x + w/2, data2_rel.a, label="2 °C" ,width=w,color = "#2FD880")
b = ax2.bar(x - w/2, data1_rel.a, label="1.5 °C" ,width=w,color = "#CAC539")#D8DE88
