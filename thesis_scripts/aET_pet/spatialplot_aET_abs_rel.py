...
inpath = "/work/malla/sachsen_output/spatial/data/aET/"
...
colorbarlabel = 'Actual Evapotranspiration [mm/yr]'
levels        = np.arange(400,620,20)
...
def ext(file):
    dd=file
    dd1= dd[indicator].mean(dim=["lat","lon"])
    return dd1
