...
ax.legend()########--------------------abs change bar plot#--------------------------

d = ax1.bar(x + 0.2, data3_abs["3K"], label="3 °C" ,width=w, color = "#E99497")
c = ax1.bar(x + w/2, data2_abs["2K"], label="2 °C" ,width=w,color = "#F3C583")
b = ax1.bar(x - w/2, data1_abs["1_5K"], label="1.5 °C" ,width=w,color = "#E8E46E")
...
d = ax2.bar(x + 0.2, data3_rel["3K"], label="3 °C" ,width=w, color = "#99154E")
c = ax2.bar(x + w/2, data2_rel["2K"], label="2 °C" ,width=w,color = "#FFC93C")
b = ax2.bar(x - w/2, data1_rel["1_5K"], label="1.5 °C" ,width=w,color = "#FFBBCC")
