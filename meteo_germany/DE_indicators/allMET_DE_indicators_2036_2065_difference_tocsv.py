...
# --------------------------------------------------
#  File:        allMET_DE_indicators_2036_2065_difference_tocsv.py 
#
...
# --------------------------------------------------
#
#  Description: script to produce csv of all METfiles(RCP26, 85) with different indicators for region GERMANY for year 2036_2065 difference from 1971_2000
#
#  Modified by: 
#  Modified date:
#
...
data.to_csv(outpath + "AllMETfiles_DE_2036_2065_difference_rcp26_85_indicators.csv")
data.to_csv("/data/hydmet/WIS_D/wis_d_indicators/model_selection/AllMETfiles_DE_2036_2065_difference_rcp26_85_indicators.csv")
