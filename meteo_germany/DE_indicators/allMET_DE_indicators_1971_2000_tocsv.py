...
# --------------------------------------------------
#  File:        allMET_DE_indicators_1971_2000_tocsv.py 
#
#  Created:     Do 22-07-2021
#  Author:      Chaitanya Malla
#  
# --------------------------------------------------
#
#  Description: script to produce csv of all METfiles with different indicators for region GERMANY for year 1971_2000
#
#  Modified by: 
#  Modified date:
#
...
data.to_csv(outpath + "AllMETfiles_DE_1971_2000_rcp26_85_indicators.csv")
