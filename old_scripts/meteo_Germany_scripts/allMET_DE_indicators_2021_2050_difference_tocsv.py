...
# --------------------------------------------------
#  File:        allMET_DE_indicators_2021_2050_difference_tocsv.py 
#
...
# --------------------------------------------------
#
#  Description: script to produce csv of all METfiles with different indicators for region GERMANY for year 2021_2050 difference with 1971_2000
#
#  Modified by: 
#  Modified date:
#
...
data.to_csv(outpath + "AllMETfiles_DE_2021_2050_difference_rcp26_85_indicators.csv")
data.to_csv("/data/hydmet/WIS_D/wis_d_indicators/model_selection/AllMETfiles_DE_2021_2050_difference_rcp26_85_indicators.csv")
