...
# --------------------------------------------------
#  File:       plot_pet_div_pre_rcps_ts.py
#
#  Created:     Mi 31-05-2021
...
#fig.savefig(inpath+"pet_div_pre_rollingmean30yrs_RCP_ts.png")
